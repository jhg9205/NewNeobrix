	...
	return (
		<div id="menuListBar">
			<ToggleButtonGroup value={menuType} exclusive onChange={handleChange} aria-label="Platform">
				<ToggleButton value={PATH.PRCENTER00}>NEWS</ToggleButton>
				<ToggleButton value={PATH.PRCENTER01}>FAQ</ToggleButton>
				<ToggleButton value={PATH.PRCENTER02}>PR 자료</ToggleButton>
			</ToggleButtonGroup>
		</div>
	)
}
