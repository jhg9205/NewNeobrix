                ...
                {getViewSize()=='lg'?
                    ...
                    >
                        <div className='intro-dream'>
                            <p className='intro-dream-title'>Neo BRIX는 임직원의 업무 효율성과 행복을 위해 노력합니다.</p>
                            <p className='intro-dream-sub'>Neobrix는 임직원의 업무 효율을 높이고 삶의 질을 향상시키기 위해 다양한 영역에서 복리후생 제도를 운영하고 있습니다.
